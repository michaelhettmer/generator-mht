 ...
 * https://github.com/yeoman/environment/blob/1a478c554cd6d65e6fe67a91c829de26bfd32d34/lib/util/log.js
 *
 * The original file is licensed under the BSD 2-Clause License.
 * BSD-2-Clause © Yeoman
 */
    ...
    if (params) {
        if (params.colors) {
            if (params.ignoreDefaultColors) {
                ...
                params.colors = Object.assign(getDefaultColors(), params.colors);
                return params;
            }
        } else {
            return Object.assign(
...
module.exports = params => {
    ...
    // @param {boolean} params.ignoreDefaultColors If this is true, ignore default colors
    //
    // Returns the logger
