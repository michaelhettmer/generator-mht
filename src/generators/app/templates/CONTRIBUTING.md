...
[![GitHub issues](https://img.shields.io/github/issues/<%= authorName %>/<%= moduleName %>)](https://github.com/<%= authorName %>/<%= moduleName %>/issues/new?assignees=&labels=&template=bug_report.md&title=)
...
[![GitHub pull requests](https://img.shields.io/github/issues-pr/<%= authorName %>/<%= moduleName %>)](https://github.com/<%= authorName %>/<%= moduleName %>/compare)
