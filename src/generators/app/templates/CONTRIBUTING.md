...
[![GitHub issues](https://img.shields.io/github/issues/<%= userName %>/<%= moduleName %>)](https://github.com/<%= userName %>/<%= moduleName %>/issues/new?assignees=&labels=&template=bug_report.md&title=)
...
[![GitHub pull requests](https://img.shields.io/github/issues-pr/<%= userName %>/<%= moduleName %>)](https://github.com/<%= userName %>/<%= moduleName %>/compare)
